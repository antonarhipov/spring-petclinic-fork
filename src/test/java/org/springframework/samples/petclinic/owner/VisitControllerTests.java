...
class VisitControllerTests {
	...
	void initNewVisitForm() throws Exception {
		mockMvc.perform(get("/staff/owners/{ownerId}/pets/{petId}/visits/new", TEST_OWNER_ID, TEST_PET_ID))
	...
	void processNewVisitFormSuccess() throws Exception {
		mockMvc
			.perform(post("/staff/owners/{ownerId}/pets/{petId}/visits/new", TEST_OWNER_ID, TEST_PET_ID).with(csrf())
				.param("name", "George")
