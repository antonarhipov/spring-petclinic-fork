...
CREATE TABLE clinic_scheduling_policies (
  ...
  urgent_care_guidance CLOB NOT NULL,
...
CREATE TABLE request_text_revisions (
  ...
  emergency_matched_terms_json CLOB,
...
CREATE TABLE interpretation_records (
  ...
  recognized_output_json CLOB,
  unknown_fields_json CLOB,
  uncertainties_json CLOB,
  validation_issues_json CLOB,
