...
@Entity
@Table(name = "vet_weekly_shift")
public class VetWeeklyShift extends BaseEntity {
	...
	public VetWeeklyShift() {
	}

	public VetWeeklyShift(Vet vet, int dayOfWeek, LocalTime startLocal, LocalTime endLocal) {
		this.vet = vet;
