...
/**
 * Controller for clinic settings (AC-96, AC-99, RULE-37).
 */
@Controller
public class ClinicSettingsController {
	...
	public String saveSettings(@ModelAttribute("form") ClinicSettingsForm form, RedirectAttributes redirectAttributes) {
